...
const App = () => {
 ...
 <div className="min-h-screen overflow-x-hidden">
       <Helmet>
        <title>Sor Visal - Software Developer</title>
        ...
        <meta property="og:title" content="Sor Visal - Software Developer" />
        ...
        <meta name="twitter:title" content="Sor Visal - Software Developer" />
